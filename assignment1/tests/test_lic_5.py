...
def make_params():
    ...
    return Parameters(
        LENGTH1=0, RADIUS1=0, EPSILON=0, AREA1=0, Q_PTS=0, QUADS=0, 
        DIST=0, N_PTS=0, K_PTS=0, A_PTS=0, B_PTS=0, C_PTS=0, D_PTS=0,
        E_PTS=0, F_PTS=0, G_PTS=0, LENGTH2=0, RADIUS2=0, AREA2=0
    )
